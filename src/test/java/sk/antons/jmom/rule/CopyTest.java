...
public class CopyTest {
	private static Logger log = Logger.getLogger(CopyTest.class.getName());
...
"}}").asObject();
	...
	public void singleCopy() throws Exception {
        ...
        v = o.findFirst(SimplePathMatcher.instance("menu", "ctx", "id"));
        
        Assert.assertNotNull("first menu", v);
        Assert.assertTrue("is array", v.isLiteral());
    }
